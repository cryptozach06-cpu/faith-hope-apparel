...
export const mockInventory: Product[] = [
  ...
  { id: 7, sku: "RWCC001", category: "Caps", name: "RedeemedWearClothing Cross Cap", price_usd: 19.99, price_php: 990, sizes: ["One Size"], colors: ["Black","White"], images: ["https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=800&h=800&fit=crop"], description: "Classic embroidered cross cap." },
  ...
  { id: 99, sku: "TEST001", category: "Test", name: "PayPal Test Item ($1)", price_usd: 1.00, price_php: 56, sizes: ["One Size"], colors: ["N/A"], images: ["https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=800&h=800&fit=crop"], description: "Test item for PayPal payment testing. This item will NOT be sent to Printful for fulfillment." }
];
